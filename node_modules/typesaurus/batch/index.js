...
function batch() {
  const commands = []
  const firestoreBatch = lazy(() =>
    __awaiter(this, void 0, void 0, function* () {
      const { firestore } = yield adaptor_1.default()
  ...
  function set(collectionOrRef, idOrData, maybeData) {
    ...
    commands.push((adaptor, firestoreBatch) => {
      ...
      firestoreBatch.set(firestoreDoc, data_1.unwrapData(adaptor, data))
    })
  }
  ...
  function update(collectionOrRef, idOrData, maybeData) {
    ...
    commands.push((adaptor, firestoreBatch) => {
      ...
      firestoreBatch.update(firebaseDoc, data_1.unwrapData(adaptor, updateData))
    })
  }
...
function lazy(fn) {
  ...
  return () =>
    __awaiter(this, void 0, void 0, function* () {
      if (instance === undefined) instance = yield fn()
      return instance
    })
}
