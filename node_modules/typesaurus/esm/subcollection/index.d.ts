...
export declare function subcollection<Model, SubcollectionModel, SubcollectionParentModel, SubcollectionIds extends [string, string, string]>(name: string, parentSubcollection: NestedSubcollection<SubcollectionModel, SubcollectionParentModel, SubcollectionIds>): NestedSubcollection<Model, SubcollectionModel, [string, string, string, string]>;
export declare function subcollection<Model, SubcollectionModel, SubcollectionParentModel, SubcollectionIds extends [string, string, string, string]>(name: string, parentSubcollection: NestedSubcollection<SubcollectionModel, SubcollectionParentModel, SubcollectionIds>): NestedSubcollection<Model, SubcollectionModel, [string, string, string, string, string]>;
