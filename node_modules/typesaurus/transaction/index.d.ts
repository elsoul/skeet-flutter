 ...
 */
export declare type TransactionReadFunction<ReadResult> = (
  api: TransactionRead
) => Promise<ReadResult>
/**
 * The transaction body function type.
 */
export declare type TransactionWriteFunction<ReadResult, WriteResult> = (
 ...
 */
export declare function transaction<ReadResult, WriteResult>(
